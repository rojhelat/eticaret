            ...
            <ul class="nav navbar-nav navbar-right">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li><a href="#" onclick="event.preventDefault();document.getElementById('cikis_form').submit()">Çıkış</a></li>
                        <form id="cikis_form" action="{{route('kullanici.cikisyap')}}" method="post" style="display: none">
                            {{csrf_field()}}
                        </form>
                    </ul>
                </li>
